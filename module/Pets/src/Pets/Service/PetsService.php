...
class PetsService
{
	...
	*/
		...
		if (count($arrDevice) > 0) {
			...
			foreach ($arrDevice as $device) {
		    	...
		    	$adapter->setOptions([
			        'curloptions' => [
			            ...
			            CURLOPT_HTTPHEADER => array(
				    		...
				    		'Authorization' => 'key=AAAAXfsCQ24:APA91bH2aWyfAfvYQUGYQ2Vgs6j8-O4OmngJ6js-n5DXYsOMPYdSqJ_zRsyS1SVAEU1jfpPdkCznE8wEJybcbGKPFwDXiIjUYw4D-Ssc70b9evD9BNdz36i6MiP2mz7_CDPHSc4cpRfv' //KEY DE FIREBASE NO CAMBIAR
						),
			    ...
			    $request->getHeaders()->addHeaders([
			    	'Content-Type'   => 'application/json',
			    	'Authorization' => 'key=AAAAXfsCQ24:APA91bH2aWyfAfvYQUGYQ2Vgs6j8-O4OmngJ6js-n5DXYsOMPYdSqJ_zRsyS1SVAEU1jfpPdkCznE8wEJybcbGKPFwDXiIjUYw4D-Ssc70b9evD9BNdz36i6MiP2mz7_CDPHSc4cpRfv'
	 ...
	 */
	public function getBreedsByTypeOfPet($typePet)
	{

		$breedsPet = $this->getPetsModel()->getBreedsByTypeOfPet($typePet);
