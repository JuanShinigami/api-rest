...
class PetsForm extends Form
{
	...
	public function __construct($name =null){
		...
		$this->add(array(
      		...
      		'options' => array (
      				'label' => 'Tamaño:',
      				'empty_option' => 'Selecciona un tamaño',
      				'value_options' => array(1 => 'Chico', 2 => 'Mediano', 3 => 'Grande', 4 => 'Extra Grande')
      		),
      		'attributes' => array(
      				'id'    => 'clothes_size',
		...
		*/
		...
		$this->add(array(
      		...
      		'options' => array(
      				...
      				'empty_option'  => 'Seleccione una opción',
      				'value_options' => array("1" => "Perro", "2" => "Gato", "3" => "Otro")
      		),
      		'attributes' => array(
      				'id'    => 'type_pet'
      		)
		...
		$this->add(array(
      		...
      		'options' => array (
      				...
      				'value_options' => array(1 => 'Chico', 2 => 'Mediano', 3 => 'Grande', 4 => 'Gigante')
      		),
      		'attributes' => array(
      				'id'    => 'size_pet'
      		)
