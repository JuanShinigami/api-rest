...
class SimulacrumGroupController extends AbstractActionController
{
    ...
    public function searchSimulacrumAction(){
        $request = $this->getRequest();
        if ($request->isPost()) {
            $postData       = $this->getRequest()->getContent();
            $decodePostData = json_decode($postData, true);
            ...
            $result = $this->getSimulacroService()->buscarPorIdSimulacro($decodePostData);
    ...
    public function searchSimulacrumFolioAction(){
        $request = $this->getRequest();
        if ($request->isPost()) {
            $postData       = $this->getRequest()->getContent();
            $decodePostData = json_decode($postData, true);
            ...
            $result = $this->getSimulacroService()->buscarPorFolioSimulacro($decodePostData);
