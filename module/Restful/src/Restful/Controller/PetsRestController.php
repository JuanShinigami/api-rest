...
use Application\Services\StatesService;
use Application\Services\DistrictService;
...
class PetsRestController extends BaseController
{
    ...
    /**
     * SECVICIO DE SECTOR DE ACTIVIDAD
     */
    ...
    /**
     * SECVICIO DE TIPO DE MASCOTA
     */
    private function getPetTypeService()
    {
        return $this->petType = new TypePetService();
    }

    /**
     * SECVICIO DE ESTADOS
     */
    private function getStatesOfMexicoService()
    {
        return $this->states = new StatesService();
    }

    /**
     * SECVICIO DE DELEGACIONES Y MUNICIPIOS
     */
    private function getDistrictService()
    {
        return $this->district = new DistrictService();
    }

    /**
     * SECVICIO DE PROVEEDORES
     */
    ...
    /**
     * OBTENER LISTA DE RAZAS POR TIPO DE MASCOTA
     */
    public function getbreedsbytypeofpetAction()
    {
        // SOLICITUD
        $request = $this->getRequest();
        ...
        if ($request->isPost()) {
            ...
            $typePet = (int) $decodePostData['type_pet'];
            
            // LISTA DE RAZAS POR TIPO DE MASCOTA
            $breedsPet = $this->getPetsService()->getBreedsByTypeOfPet($typePet);
            //echo "<pre>"; print_r($breedsPet); exit;
    ...
    /**
     * OBTENER LISTA DE SECTOR DE ACTIVIDAD
     */
    public function getallactivitysectorAction()
    {
        // SOLICITUD
        $request = $this->getRequest();
        ...
        if ($request->isPost()) {
            ...
            // LISTA DE SECTORES DE ACTIVIDAD
            $sectorActivity = $this->getPetActivitySectorService()->fetchAll();
    ...
    /**
     * OBTENER LISTA DE TIPO DE MASCOTA
     */
    public function getallpettypeAction()
    {
        // SOLICITUD
        $request = $this->getRequest();
        ...
        if ($request->isPost()) {
            ...
            $petType = $this->getPetTypeService()->fetchAll();
     ...
     */
    public function getallstatesofmexicoAction()
    {
        // SOLICITUD
        $request = $this->getRequest();
        ...
        if ($request->isPost()) {
            ...
            // LISTA DE ESTADOS
            $statesOfMexico = $this->getStatesOfMexicoService()->fetchAll();

            // RESPUESTA DEL WS
            $response = $this->getResponse()->setContent(\Zend\Json\Json::encode(array(
                "statesOfMexico" => $statesOfMexico
            )));
    ...
    /**
     * OBTENER LISTA DE MUNICIPIOS Y DELEGACIONES
     */
    public function getalldistrictbystateAction()
    {
        // SOLICITUD
        $request = $this->getRequest();
        ...
        if ($request->isPost()) {
            ...
            // LISTA DE MUNICIPIOS Y DELEGACIONES
            $districts = $this->getDistrictService()->fetchAll($decodePostData['id_state']);
     ...
     */
    public function searchsuppliersAction()
    {
        // SOLICITUD
        $request = $this->getRequest();
        ...
        if ($request->isPost()) {
            ...
            // BUSCAR PROVEEDORES
            $suppliers = $this->getsupplierservice()->fetchAllByFilter($decodePostData);
