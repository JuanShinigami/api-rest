...
$message = new Message();
$message->addTo('recupera@recupera.net')
				...
				<div class="row">
					...
					<div class="col s4"
						...
						<div
		                  ...
		                  <a href="https://recupera.pet/auth/passwordrecovery/'.$token.'" target="_self"><button style="width: 200px; height: 50px; background-color: #57585A; color: white; font-style: inherit;">RECUPERAR CONTRASEÑA</button></a>
