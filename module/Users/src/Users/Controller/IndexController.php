...
class IndexController extends BaseController
{
    ...
    public function registerAction()
    {
     ...
     public function perfilproviderAction()
    {
...
*/
    ...
    public function editperfilproviderAction()
    {
         $perfilUser = (int) $this->getPerfilUserSesion();
       ...
       // echo "<pre>"; print_r($request); exit;
        if($request->isPost()){
           ...
           // $formData   = $request->getPost()->toArray();
            ...
            $editPerfil = $this->getUsersServices()->editPerfilprovider($formData);
            
            if($editPerfil){
                return $this->redirect()->toUrl($this->getRequest()->getBaseUrl().'/users/perfilprovider');
            }else{
